...
L'utilisateur charge un document.
Le système calcule son empreinte (hash).
Cette empreinte est signée avec la clé privée.
Une signature détachée (`.sig`) est générée.
...
---
👨‍💻 Auteur
Jacob Rino Andrianjara, RAFANOMEZANTSOA Crescent Berthieu Victorien et TSIRESILAZA Deraniaina Noël
Projet CFCS académique réalisé dans le cadre du Master en Objets Connectés et Cybersécurité à l'École Nationale d'Informatique (ENI).
